...
export const BUILTIN_COMMANDS = [
  { key: 'welcome_test', name: 'welcome_test', type: 'prefix', module: 'welcome', usage: '{p}welcome_test · /welcome_test', description: 'Send a test welcome message (admin).' },
  { key: 'birthday', name: 'birthday', type: 'prefix', module: 'birthday', usage: '{p}birthday DD.MM[.YYYY] · /birthday', description: 'Save your birthday.' },
  { key: 'suggest', name: 'suggest', type: 'prefix', module: 'suggestions', usage: '{p}suggest <text> · /suggest', description: 'Submit a suggestion.' },
  ...
  { key: 'claim', name: 'claim', type: 'prefix', module: 'tickets', usage: '{p}claim · /claim', description: 'Claim the current ticket (staff).' },
  { key: 'ticketadd', name: 'ticketadd', type: 'prefix', module: 'tickets', usage: '{p}ticketadd @user · /ticketadd', description: 'Add a user to the current ticket (staff).' },
  { key: 'ticketremove', name: 'ticketremove', type: 'prefix', module: 'tickets', usage: '{p}ticketremove @user · /ticketremove', description: 'Remove a user from the current ticket (staff).' },
  { key: 'ticketclose', name: 'ticketclose', type: 'prefix', module: 'tickets', usage: '{p}ticketclose · /ticketclose', description: 'Close the current ticket (staff/owner).' },
  ...
  { key: 'applypanel', name: 'applypanel', type: 'prefix', module: 'applications', usage: '{p}applypanel · /applypanel', description: 'Post the application panel (admin).' },
  { key: 'balance', name: 'balance', type: 'prefix', module: 'economy', usage: '{p}balance [member]', description: 'Show a balance.' },
  { key: 'daily', name: 'daily', type: 'prefix', module: 'economy', usage: '{p}daily · /daily', description: 'Claim the daily reward.' },
  { key: 'work', name: 'work', type: 'prefix', module: 'economy', usage: '{p}work · /work', description: 'Work for currency.' },
  { key: 'pay', name: 'pay', type: 'prefix', module: 'economy', usage: '{p}pay @user <amount> · /pay', description: 'Transfer currency to a member.' },
  { key: 'rich', name: 'rich', type: 'prefix', module: 'economy', usage: '{p}rich · /rich', description: 'Show the balance leaderboard.' },
  { key: 'shop', name: 'shop', type: 'prefix', module: 'economy', usage: '{p}shop · /shop', description: 'List shop items.' },
  { key: 'buy', name: 'buy', type: 'prefix', module: 'economy', usage: '{p}buy <item> · /buy', description: 'Buy a shop item.' },
  { key: 'ttt', name: 'ttt', type: 'prefix', module: 'games', usage: '{p}ttt @opponent · /ttt', description: 'Start a Tic-Tac-Toe match.' },
  { key: 'rps', name: 'rps', type: 'prefix', module: 'games', usage: '{p}rps [@opponent] · /rps', description: 'Play Rock-Paper-Scissors.' },
  { key: 'trivia', name: 'trivia', type: 'prefix', module: 'games', usage: '{p}trivia · /trivia', description: 'Start a trivia question.' },
  { key: 'connect4', name: 'connect4', type: 'prefix', module: 'games', usage: '{p}connect4 @opponent · /connect4', description: 'Start a Connect Four match.' },
  { key: 'hangman', name: 'hangman', type: 'prefix', module: 'games', usage: '{p}hangman · /hangman', description: 'Start a Hangman game.' },
  { key: 'poker', name: 'poker', type: 'prefix', module: 'games', usage: '{p}poker · /poker', description: 'Open a Texas Hold’em table.' },
