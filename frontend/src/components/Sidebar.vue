...
const groups = computed(() => [
  {
    ...
    links: [
      ...
      {
        to: `/dashboard/${props.guildId}/botprofile`,
        label: t('sidebar.linkBotProfile'),
        icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 21v-1a6 6 0 0 1 6-6h4a6 6 0 0 1 6 6v1"/><path d="m17 3 1.5 1.5L21 2"/></svg>'
      },
      {
  ...
  },
  {
    ...
    links: [
      ...
      {
        to: `/dashboard/${props.guildId}/music`,
        label: t('sidebar.linkMusic'),
  ...
  },
  {
    ...
    links: [
      ...
      {
        to: `/dashboard/${props.guildId}/minecraft`,
        label: t('sidebar.linkMinecraft'),
