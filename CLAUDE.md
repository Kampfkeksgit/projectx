...
│           ├── Admin.vue           # /admin (OWNER-only — Tabs Overview/Analytics/Premium/Health/Users/Guilds/Audit/Jobs/Errors/Marketplace/Team/Partners/Changelog/System; Router-Guard requiresOwner)
...
- Migrations: [backend/migrations.js](backend/migrations.js)
  - **Aktuelle Schema-Version: `51`**
  - `CURRENT_SCHEMA_VERSION` Konstante steuert Upgrades.
  - `applyMigrations(from, to)` mappt Versionsnummern → Migration-Funktionen (`migrationV1`, …, `migrationV51`). v23–v51 nutzen den `runSchemaBatch(version, statements)`-Helper.
