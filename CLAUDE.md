...
│           ├── Admin.vue           # /admin (OWNER-only — Tabs Overview/Analytics/Premium/Health/Users/Guilds/Audit/Jobs/Errors/Marketplace/Team/Changelog/System; Router-Guard requiresOwner)
...
- Migrations: [backend/migrations.js](backend/migrations.js)
  - **Aktuelle Schema-Version: `50`**
  - `CURRENT_SCHEMA_VERSION` Konstante steuert Upgrades.
  - `applyMigrations(from, to)` mappt Versionsnummern → Migration-Funktionen (`migrationV1`, …, `migrationV50`). v23–v50 nutzen den `runSchemaBatch(version, statements)`-Helper.
