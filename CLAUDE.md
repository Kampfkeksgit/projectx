...
- Migrations: [backend/migrations.js](backend/migrations.js)
  - **Aktuelle Schema-Version: `53`**
  - `CURRENT_SCHEMA_VERSION` Konstante steuert Upgrades.
  - `applyMigrations(from, to)` mappt Versionsnummern → Migration-Funktionen (`migrationV1`, …, `migrationV53`). v23–v53 nutzen den `runSchemaBatch(version, statements)`-Helper.
