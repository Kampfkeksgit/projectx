...
- Migrations: [backend/migrations.js](backend/migrations.js)
  - **Aktuelle Schema-Version: `43`**
  - `CURRENT_SCHEMA_VERSION` Konstante steuert Upgrades.
  - `applyMigrations(from, to)` mappt Versionsnummern → Migration-Funktionen (`migrationV1`, …, `migrationV43`). v23–v43 nutzen den `runSchemaBatch(version, statements)`-Helper.
